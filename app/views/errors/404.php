<div class="empty-state" style="min-height:60vh; display:flex; flex-direction:column; align-items:center; justify-content:center;">
  <i class="bi bi-file-earmark-x" style="font-size:4rem; color:rgba(196,181,253,.45); display:block; margin-bottom:1rem;"></i>
  <h2 class="fw-bold">Page not found</h2>
  <p class="text-muted">This page doesn't exist, was removed, or hasn't been approved yet.</p>
